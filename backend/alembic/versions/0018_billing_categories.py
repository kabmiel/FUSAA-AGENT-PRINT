...
def upgrade():
    ...
    with op.batch_alter_table("products") as batch: batch.add_column(sa.Column("billing_category_id",sa.String(36),sa.ForeignKey("billing_categories.id"),nullable=True))
