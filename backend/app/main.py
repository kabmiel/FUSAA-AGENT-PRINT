...
def shop_js():
    ...
    layout_fixes += ".top{width:100%!important}.wrap{width:100%!important;max-width:1740px!important;margin-left:auto!important;margin-right:auto!important}@media(min-width:1101px){.products{grid-template-columns:repeat(4,minmax(0,1fr))}}"
